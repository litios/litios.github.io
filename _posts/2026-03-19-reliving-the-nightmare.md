...
A while ago, I created an exploit for IngressNightmare [here](https://www.notion.so/Ingress-nightmare-pt2-328ac91f8b058020a341d612828b9027?pvs=21) which followed a similar pattern of injection in `nginx.conf` . 
...
While reading the nginx options available, I stumbled upon `client_body_in_file_only` ([docs](https://nginx.org/en/docs/http/ngx_http_core_module.html#client_body_in_file_only))
...
<img src="/./assets/imgs/nightmareagain.png">
